...
<body>
    ...
    <div id="searchBar">
        <div id="searchbar" class="row">
            ...
            <form method="GET" class="navSearchBox" action="/back-end/actions/filters.php">
                <input type="text" name="searchbar_content" id="searchbarContent" placeholder="Search Pradish" />
                <button type="submit" class="searchButton">
                    <img class="searchIcon svg" src="./assets/img/magnifying-glass-solid.svg" alt="magnifying glass"
                        @click="fonctionDeRecherche" />
                </button>
            </form>
        </div>
    </div>
