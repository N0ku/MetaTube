...
<button class="feature-channel-modal-open" onclick="feature_open_upload_function()">Open Modal</button>

    <!-- Add js library and script here -->
    <script src="./assets/js/feature-channel-modal-uploadVideo.js"></script>
</body>
