...
/*$opts = array(
	...
	$fp = fopen('http://93.16.2.231:8081/' . 'video/q12TFuL18592n4l0irF1', 'r', false, $context);
	fpassthru($fp);
	fclose($fp);
    //$context = json_decode(strval($context));
	var_dump($context);*/
ob_start(); ?>
<div class="watchPage">
            ...
            <div class="container">
                <div class="video-container" id="video-container">
                    ...
                    <video controls class="video" id="video" preload="metadata" poster="poster.jpg">
                        <source src="../../../storage/FOJM5e0F8RHkh2A95L4H.mp4" type="video/mp4">
                        </source>
                    </video>
