 <button class="btnprofile" onclick="document.getElementById('password').style.display='block'"><?=$enJson['profile']['button']['buttonPassword']?></button>




 <div id="password" class="modal" <?php if (isset($_SESSION['process']) == 'password') echo 'style = "display : block";' ?>>
    <form class="modal-content" enctype="multipart/form-data" id="formUpdatePass" method="post" action="/back-end/actions/UpdatePassword.php">
       ...
       <div class="wrapper-part-profile">
          ...
          <div>
             <label class="label-form" for="password"><?=$enJson['profile']['passModal']['confirmpassword']?></label>
