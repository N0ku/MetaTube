...
<nav class="wrapper--navbar">
    <div class="box--navbar">
        ...
        <div class="navbar--center">
            ...
            <a href='index.php?name=SearchPage'>
        ...
        <div class="navbar--side">
            <div class="btn--navbar--icon" onclick="">
                <a><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none"
