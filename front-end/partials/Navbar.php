...
<nav class="wrapper--navbar">
   <div class="box--navbar">
      ...
      <div class="navbar--center">
         ...
         <button class="navbar__center__search-btn tooltip">
            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="navbar--logo">
               <circle cx="11" cy="11" r="8"></circle>
               <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
            </svg>
            <span class="tooltiptext"><?= $enJson['profile']['navBar']['tooltipSearch'] ?></span>
         </button>
      </div>
      <div class="navbar--side">
         ...
         <div class="btn--navbar--register tooltip">
            <a href="index.php?name=Login ">Login</a>
            <span class="tooltiptext"><?= $enJson['profile']['navBar']['tooltipLogin'] ?></span>
         </div>
         <div class="dropdown">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzslQrjpEHSPbE3teWMa1qA8fUwgRlbg4bGA&usqp=CAU" alt="" onclick="myFunction()" style="width: 60px; border-radius: 50%" class="dropbtn" />
            <div id="myDropdown" class="dropdown-content">
               <div class="drop-profil">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzslQrjpEHSPbE3teWMa1qA8fUwgRlbg4bGA&usqp=CAU" alt="" style="width: 60px; border-radius: 50%" />
                  <h3>UserName</h3>
               </div>
               <hr />
               <div class="drop-profil">
               ...
               <!-- LINK TO CHANNEL -->
               <a class="drop--element--btn--account" onclick="feature_open_accountCreator_function()" href="index.php?name=channel_page">
                  <div>
                     <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
